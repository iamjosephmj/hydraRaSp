...
version = findProperty("VERSION_NAME")?.toString() ?: "3.0.3"
...
dependencies {
    ...
    implementation(files("libs/deviceintelligence-gradle-4.9.9.jar"))
    implementation(files("libs/deviceintelligence-baker-4.9.9.jar"))
...
tasks.jar {
    ...
    from(zipTree("libs/deviceintelligence-gradle-4.9.9.jar")) { exclude("META-INF/**") }
    from(zipTree("libs/deviceintelligence-baker-4.9.9.jar")) { exclude("META-INF/**") }
}
