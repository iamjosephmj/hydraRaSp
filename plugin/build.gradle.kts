...
dependencies {
    ...
    implementation(files("libs/deviceintelligence-gradle-4.9.0.jar"))
    implementation(files("libs/deviceintelligence-baker-4.9.0.jar"))
...
tasks.jar {
    ...
    from(zipTree("libs/deviceintelligence-gradle-4.9.0.jar")) { exclude("META-INF/**") }
    from(zipTree("libs/deviceintelligence-baker-4.9.0.jar")) { exclude("META-INF/**") }
}
