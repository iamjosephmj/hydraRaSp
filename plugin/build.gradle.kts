...
dependencies {
    ...
    implementation(files("libs/deviceintelligence-gradle-4.9.6.jar"))
    implementation(files("libs/deviceintelligence-baker-4.9.6.jar"))
...
tasks.jar {
    ...
    from(zipTree("libs/deviceintelligence-gradle-4.9.6.jar")) { exclude("META-INF/**") }
    from(zipTree("libs/deviceintelligence-baker-4.9.6.jar")) { exclude("META-INF/**") }
}
